...
> Version 2.0 released with ESM `import { read } from "files";` 🎉, compatible with Node.js 12+. If you prefer the `require()` way or use older Node.js, please `npm install files@1`.
