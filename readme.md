...
> Version 2.0 released with ESM `import files from "files";` 🎉, compatible with recent Node.js versions. If you prefer the `require()` way, please `npm install files@1`.
